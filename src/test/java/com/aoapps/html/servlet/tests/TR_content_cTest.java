 ...
 */
public class TR_content_cTest extends AnyTR_content_cTest {

  public TR_content_cTest() {
    super(TR_content_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ElementContentModel_cTest.getAllElementContentModels(), TR_content_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(ContentEE_c.class, TR_content_c.class);
  }
}
