...
import com.aoapps.html.any.tests.AnyScriptSupportingContent_cTest;
...
/**
 * @see  ScriptSupportingContent_c
 *
 * @author  AO Industries, Inc.
 */
public class ScriptSupportingContent_cTest extends AnyScriptSupportingContent_cTest {

  public ScriptSupportingContent_cTest() {
    super(ScriptSupportingContent_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ContentModel_cTest.getAllContentModels(), ScriptSupportingContent_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(ContentEE_c.class, ScriptSupportingContent_c.class);
  }
}
