...
import com.aoapps.html.any.tests.AnyUnion_Metadata_Phrasing_cTest;
...
/**
 * @see  Union_Metadata_Phrasing_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings({"rawtypes", "unchecked"})
public class Union_Metadata_Phrasing_cTest extends AnyUnion_Metadata_Phrasing_cTest {

  public Union_Metadata_Phrasing_cTest() {
    super(Union_Metadata_Phrasing_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals("Must be included in " + UnionContent_cTest.class.getSimpleName() + ".getAllUnions()",
        -1,
        AoArrays.indexOf(UnionContent_cTest.getAllUnions(), Union_Metadata_Phrasing_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(ContentEE_c.class, Union_Metadata_Phrasing_c.class);
  }
}
