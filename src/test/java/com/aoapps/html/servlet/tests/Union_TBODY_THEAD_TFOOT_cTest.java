...
import com.aoapps.html.any.tests.AnyUnion_TBODY_THEAD_TFOOT_cTest;
...
/**
 * @see  Union_TBODY_THEAD_TFOOT_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings({"rawtypes", "unchecked"})
public class Union_TBODY_THEAD_TFOOT_cTest extends AnyUnion_TBODY_THEAD_TFOOT_cTest {

  public Union_TBODY_THEAD_TFOOT_cTest() {
    super(Union_TBODY_THEAD_TFOOT_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals("Must be included in " + UnionContent_cTest.class.getSimpleName() + ".getAllUnions()",
        -1,
        AoArrays.indexOf(UnionContent_cTest.getAllUnions(), Union_TBODY_THEAD_TFOOT_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(ContentEE_c.class, Union_TBODY_THEAD_TFOOT_c.class);
  }
}
