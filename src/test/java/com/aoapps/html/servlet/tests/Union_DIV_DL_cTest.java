...
import com.aoapps.html.any.tests.AnyUnion_DIV_DL_cTest;
...
public class Union_DIV_DL_cTest extends AnyUnion_DIV_DL_cTest {

  public Union_DIV_DL_cTest() {
    super(Union_DIV_DL_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals("Must be included in " + UnionContent_cTest.class.getSimpleName() + ".getAllUnions()",
        -1,
        AoArrays.indexOf(UnionContent_cTest.getAllUnions(), Union_DIV_DL_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(ContentEE_c.class, Union_DIV_DL_c.class);
  }
}
