...
import com.aoapps.html.any.tests.AnyDL_content_cTest;
import com.aoapps.html.any.tests.InheritanceTestHelper;
import com.aoapps.html.servlet.ContentEE_c;
import com.aoapps.html.servlet.DL_content_c;
 ...
 */
public class DL_content_cTest extends AnyDL_content_cTest {

  public DL_content_cTest() {
    super(DL_content_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ElementContentModel_cTest.getAllElementContentModels(), DL_content_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(ContentEE_c.class, DL_content_c.class);
  }
}
