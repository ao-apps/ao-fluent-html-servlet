...
import com.aoapps.html.any.tests.AnyFlowContent_cTest;
 ...
 */
public class FlowContent_cTest extends AnyFlowContent_cTest {

  public FlowContent_cTest() {
    super(FlowContent_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ContentModel_cTest.getAllContentModels(), FlowContent_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(ContentEE_c.class, FlowContent_c.class);
  }
}
