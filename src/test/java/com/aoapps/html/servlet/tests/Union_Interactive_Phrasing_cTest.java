...
import com.aoapps.html.any.tests.AnyUnion_Interactive_Phrasing_cTest;
...
/**
 * @see  Union_Interactive_Phrasing_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings({"rawtypes", "unchecked"})
public class Union_Interactive_Phrasing_cTest extends AnyUnion_Interactive_Phrasing_cTest {

  public Union_Interactive_Phrasing_cTest() {
    super(Union_Interactive_Phrasing_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals("Must be included in " + UnionContent_cTest.class.getSimpleName() + ".getAllUnions()",
        -1,
        AoArrays.indexOf(UnionContent_cTest.getAllUnions(), Union_Interactive_Phrasing_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(ContentEE_c.class, Union_Interactive_Phrasing_c.class);
  }
}
