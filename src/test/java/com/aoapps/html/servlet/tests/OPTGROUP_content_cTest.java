...
import com.aoapps.html.any.tests.AnyOPTGROUP_content_cTest;
...
/**
 * @see  OPTGROUP_content_c
 *
 * @author  AO Industries, Inc.
 */
public class OPTGROUP_content_cTest extends AnyOPTGROUP_content_cTest {

  public OPTGROUP_content_cTest() {
    super(OPTGROUP_content_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals(
        ...
        -1,
        AoArrays.indexOf(ElementContentModel_cTest.getAllElementContentModels(), OPTGROUP_content_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(ContentEE_c.class, OPTGROUP_content_c.class);
  }
}
