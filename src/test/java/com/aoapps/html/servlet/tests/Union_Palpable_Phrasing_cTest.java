...
import com.aoapps.html.any.tests.AnyUnion_Palpable_Phrasing_cTest;
...
/**
 * @see  Union_Palpable_Phrasing_c
 *
 * @author  AO Industries, Inc.
 */
@SuppressWarnings({"rawtypes", "unchecked"})
public class Union_Palpable_Phrasing_cTest extends AnyUnion_Palpable_Phrasing_cTest {

  public Union_Palpable_Phrasing_cTest() {
    super(Union_Palpable_Phrasing_c.class);
  }
  ...
  public void testNoImplementInherited() {
    Assert.assertNotEquals("Must be included in " + UnionContent_cTest.class.getSimpleName() + ".getAllUnions()",
        -1,
        AoArrays.indexOf(UnionContent_cTest.getAllUnions(), Union_Palpable_Phrasing_c.class)
    );
    InheritanceTestHelper.testNoImplementInherited(ContentEE_c.class, Union_Palpable_Phrasing_c.class);
  }
}
