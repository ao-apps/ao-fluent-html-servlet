...
public abstract class INPUT {
	...
	> extends
		AnyINPUT.Dynamic<DocumentEE, PC, Dynamic<PC>> {
		...
		@Override
		protected INPUT.Dynamic<PC> writeOpen(Writer out) throws IOException {
	...
	public static final class Button<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Button<DocumentEE, PC, Button<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Button<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Checkbox<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Checkbox<DocumentEE, PC, Checkbox<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Checkbox<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Color<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Color<DocumentEE, PC, Color<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Color<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Date<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Date<DocumentEE, PC, Date<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Date<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class DatetimeLocal<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.DatetimeLocal<DocumentEE, PC, DatetimeLocal<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.DatetimeLocal<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Email<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Email<DocumentEE, PC, Email<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Email<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class File<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.File<DocumentEE, PC, File<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.File<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Hidden<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Hidden<DocumentEE, PC, Hidden<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Hidden<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Image<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Image<DocumentEE, PC, Image<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Image<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Month<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Month<DocumentEE, PC, Month<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Month<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Number<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Number<DocumentEE, PC, Number<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Number<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Password<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Password<DocumentEE, PC, Password<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Password<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Radio<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Radio<DocumentEE, PC, Radio<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Radio<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Range<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Range<DocumentEE, PC, Range<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Range<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Reset<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Reset<DocumentEE, PC, Reset<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Reset<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Search<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Search<DocumentEE, PC, Search<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Search<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Submit<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Submit<DocumentEE, PC, Submit<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Submit<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Tel<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Tel<DocumentEE, PC, Tel<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Tel<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Text<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Text<DocumentEE, PC, Text<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Text<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Time<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Time<DocumentEE, PC, Time<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Time<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Url<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Url<DocumentEE, PC, Url<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Url<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
	...
	public static final class Week<
		PC extends Union_Interactive_Phrasing<PC>
	> extends
		AnyINPUT.Week<DocumentEE, PC, Week<PC>> {
		...
		// Expose to this package, avoiding public to keep a clean API for optimal code assist
		@Override
		protected INPUT.Week<PC> writeOpen(Writer out) throws IOException {
			return super.writeOpen(out);
		}
	}
}
